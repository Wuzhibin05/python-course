...
print(av_catalog)
# av_catalog.popitem("letmedothistoyou.com")
# del av_catalog["欧美"]["letmedothistoyou.com"]
ret=av_catalog["欧美"].pop("letmedothistoyou.com","faled")
print(ret,av_catalog)
